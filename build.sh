...
zip -r sensor.zip sensorwindow statics views conf
scp sensor.zip root@119.23.75.129:/root/apps/sensorwindow/
ssh root@119.23.75.129 'cd /root/apps/sensorwindow;rm -rf sensorwindow statics views conf; unzip sensor.zip;rm sensor.zip' 
