...
;(function($) {
	...
	$.validator.addMethod( "UserName", function( value, element ) {
		...
		var isOk=!(regEMail.test(value)||regPhone.test(value));
	...
	// 	var faxNum = /(^[0-9]…{3,4}-[0-9]…{3,8}$)|(^[0-9]…{3,8}$)|(^([0-9]…{3,4})[0-9]…{3,8}$)|(^0…{0,1}13[0-9]…{9}$)/;
	// 	return this.optional( element ) || faxNum.test( value );
	// }, "请输入正确的传真号码" );
})(jQuery);
